...
if ($Description == '' or  $CostPrice == ''  or $SalePrice == '' or $Quantity=='' )                
{                                                                                     
...
$cForename = mysqli_real_escape_string($dbcnx, $Description);


        //Inserting data into database
$sql = "INSERT INTO Stock(Description,CostPrice,SalePrice,Quantity) VALUES('$Description','$CostPrice', '$SalePrice','$Quantity')";
...
if ($res == 0) 
     ...
     {
	echo("<a href='AddStock.html'> Add another Stock Item </a>");
     }
